...
apitoken = "dc743029-1d2b-4f6b-b938-9b6877564709"
...
def getTDDLKPS(p):
    ...
    subject_metadata = {"typeName": "subject", "multiple": True, "value": ["Social Sciences"],
                        "typeClasubject_metadata": "controlledVocabulary"}
...
if __name__ == '__main__':
    ...
    for i in reader:
        ...
        # but not needed for just metadata upload
            ...
            blank_json["datasetVersion"]["metadataBlocks"]["citation"]["fields"] = \
                [title_md, date_md, desc_md, subject_md, author_md, language_md, place_md, contact_md, keyword_md]
